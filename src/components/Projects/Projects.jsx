...
export default function Projects(props){
    ...
    const [getData] = useLazyQuery(GET_PROJECTS_NAME,{
        ...
        onCompleted({projectName}){
            ...
            projectName!=null?setResultadoBuscar(projectName.name):setResultadoBuscar("");
        ...
        <>  
            <article className="buscar-proyecto">                            
                ...
                <form className="buscar" action="#">
                    <input value={inputBuscar} onInput={e => {
                ...
                <ul>
                    {resultadoBuscar===inputBuscar? renderBusqueda():renderProjects()} 
                </ul> }                         
            </article>
